...
public class SQLServerGenerator extends GeneratorTest {
    ...
    public static void main(String[] args) {
        ...
        AutoGenerator mpg = new AutoGenerator().setGlobalConfig(
                // 全局配置
                new GlobalConfig()
                        .setOutputDir(System.getProperty("user.dir")+"/ops")//输出目录
                ...
                new DataSourceConfig()
                        ...
                        .setUrl("jdbc:sqlserver://localhost\\SQLEXPRESS01;Database=test;integratedSecurity=true;Trusted_Connection=True")
        ).setStrategy(
                // 策略配置
                new StrategyConfig()
                        // .setCapitalMode(true)// 全局大写命名
                        // .setDbColumnUnderline(true)//全局下划线命名
                        .setTablePrefix(new String[]{"code_"})// 此处可以修改为您的表前缀
                        .setNaming(NamingStrategy.underline_to_camel)// 表名生成策略
                        .setInclude(new String[] { "code_generate" }) // 需要生成的表
